...
public class SocialNetworkingStepDef {
	...
	String apiURL;
		...
		//Requesting API with parameters
		@When("^requesting (post|comments|users) api with \"([^\"]*)\"$")
		public void requestingApiWith(String resource, String params) throws Throwable {
		...
		@Then("^Verify (post|comments|users) api response counts \"([^\"]*)\"$")
		public void verifyApiResponseCounts(String resource, String noOfResponses) throws Throwable {
